...
urlpatterns = [
  ...
  path('tasks/<int:entry_id>/assoc_completedtasks/', views.assoc_completedtasks, name='assoc_completedtasks'),
  ...
  path('entries/<int:entry_id>/assoc_completedworkouts/', views.assoc_completedworkouts, name='assoc_completedworkouts'),
