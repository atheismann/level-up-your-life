...
urlpatterns = [
  ...
  path('entries/<int:entry_id>/assoc_completedworkouts/<int:workout_id>/', views.assoc_completedworkouts, name='assoc_completedworkouts'),
  ...
  path('tasks/<int:entry_id>/assoc_completedtasks/<int:task_id>/', views.assoc_completedtasks, name='assoc_completedtasks'),
